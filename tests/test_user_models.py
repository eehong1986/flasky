...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_admin_user(self):
        u = User(email=current_app.config['FLASKY_ADMIN'], password='cat')
        self.assertTrue(u.is_administrator())
        self.assertTrue(u.username == None)
    ...
    def test_ping(self):
        ...
        u.ping()
        self.assertTrue(
                (u.last_seen - last_seen_before).total_seconds() > 3)
    ...
    def test_to_json(self):
        ...
        db.session.commit()
        json_user = u.to_json()
        expected_keys = ['url', 'user_name', 'member_since', 'last_seen', 
